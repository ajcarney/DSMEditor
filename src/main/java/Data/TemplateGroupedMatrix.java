...
/**
 * Extends the functionality of a TemplateDSM to add groupings. Contains methods for handling groupings
 */
public abstract class TemplateGroupedMatrix extends TemplateDSM {
