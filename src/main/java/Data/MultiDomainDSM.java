...
//region Constructors
    /**
     * Creates a new MultiDomainDSM object. Creates no row or column items and metadata are empty strings.
     * There is one domain, which is the default: "(None)"
     */
    public MultiDomainDSM() {
        super();
    ...
    /**
     * Copy constructor for MultiDomainDSM class. Performs a deep copy
     *
     * @param copy  MultiDomainDSM object to copy
     */
    public MultiDomainDSM(MultiDomainDSM copy) {
        super();
