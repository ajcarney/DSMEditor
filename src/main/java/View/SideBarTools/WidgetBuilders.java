...
public class WidgetBuilders {
     ...
     */
    public static Callback<ListView<DSMConnection>, ListCell<DSMConnection>> getConnectionCellFactory(TemplateDSM matrix) {
        return new Callback<>() {
            @Override
     ...
     */
    public static Callback<ListView<DSMConnection>, ListCell<DSMConnection>> getDeleteConnectionCellFactory(TemplateDSM matrix) {
        return new Callback<>() {
            @Override
            public ListCell<DSMConnection> call(ListView<DSMConnection> l) {
                return new ListCell<>() {
     ...
     */
    public static Callback<ListView<Integer>, ListCell<Integer>> getMatrixItemIntegerComboBoxCellFactory(TemplateDSM matrix) {
        return new Callback<>() {
            @Override
     ...
     */
    public static Callback<ListView<DSMItem>, ListCell<DSMItem>> getMatrixItemComboBoxCellFactory(TemplateDSM matrix) {
        return new Callback<>() {
            @Override
     ...
     *
     * @param matrix                the TemplateDSM matrix the widget is for
