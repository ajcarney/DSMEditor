...
// * @author Aiden Carney
// */
//public class MatrixGuiHandler_old {
//
//    /**
...
//     */
//    public MatrixGuiHandler_old(SymmetricDSM matrix, double fontSize) {
//        this.matrix = matrix;
//        cells = new Vector<>();
...
//                    cell.getChildren().add(g);
//                } else if(item.getKey().equals("grouping_item")) {
//                    Label label = new Label(((DSMItem)item.getValue()).getGroup());
//                    cell.setAlignment(Pos.BOTTOM_RIGHT);
//                    label.setMinWidth(Region.USE_PREF_SIZE);
//                    cell.getChildren().add(label);
//                } else if(item.getKey().equals("grouping_item_v")) {
