...
//import IOHandler.ExportHandler_old;
//import IOHandler.ImportHandler_old;
...
//                SymmetricDSM matrix = ImportHandler_old.readFile(file);
//                if(matrix == null) {
...
//            File file = fileChooser.showOpenDialog(menuBar.getScene().getWindow());
//            if(file != null) {  // make sure user did not just close out of the file chooser window
//                SymmetricDSM matrix = ImportHandler_old.importThebeauMatlabFile(file);
//                if(matrix == null) {
//                    // TODO: open window saying there was an error parsing the document
//                    System.out.println("there was an error reading the file " + file.toString());
//                } else if(!matrixHandler.getMatrixSaveNames().containsValue(file)) {
...
//                }
//            }
//            int code = ExportHandler_old.saveMatrixToFile(matrixHandler.getMatrix(editor.getFocusedMatrixUid()), matrixHandler.getMatrixSaveFile(editor.getFocusedMatrixUid()));  // TODO: add checking with the return code
//
//        });
//
...
//            File fileName = fileChooser.showSaveDialog(menuBar.getScene().getWindow());
//            if(fileName != null) {
//                int code = ExportHandler_old.saveMatrixToFile(matrixHandler.getMatrix(editor.getFocusedMatrixUid()), fileName);  // TODO: add checking with the return code
...
//                return;
//            }
//            ExportHandler_old.promptExportToCSV(matrixHandler.getMatrix(editor.getFocusedMatrixUid()), menuBar.getScene().getWindow());
//        });
...
//                return;
//            }
//            ExportHandler_old.promptExportToExcel(matrixHandler.getMatrix(editor.getFocusedMatrixUid()), menuBar.getScene().getWindow());
//        });
...
//                return;
//            }
//            ExportHandler_old.promptExportToThebeau(matrixHandler.getMatrix(editor.getFocusedMatrixUid()), menuBar.getScene().getWindow());
//        });
...
//                return;
//            }
//            ExportHandler_old.exportToImage(matrixHandler.getMatrix(editor.getFocusedMatrixUid()));
//        });
//
...
//                    clearRows = true;
//                }
//                ExportHandler_old.convertToNonSymmetrical(matrixHandler.getMatrix(editor.getFocusedMatrixUid()), clearRows);
//                window.close();
//                editor.refreshTab();
//            });
...
//                    }
//
//                    MatrixGuiHandler_old m = matrixHandler.getMatrixGuiHandler(editor.getFocusedMatrixUid());
//
...
//                                m.clearCellHighlight(m.getGridLocFromUids(pair), "symmetryError");
//                            } else {
//                                m.setCellHighlight(m.getGridLocFromUids(pair), MatrixGuiHandler_old.SYMMETRY_ERROR_BACKGROUND, "symmetryError");
//                            }
//                        }
//                    }
//
